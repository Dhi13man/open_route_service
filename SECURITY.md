...
Security reports are welcome and should stay private until a fix or mitigation is available.

## Supported versions

Only the latest version published on [pub.dev](https://pub.dev/packages/open_route_service) receives security fixes. Upgrade before reporting an issue that affects an older release.
